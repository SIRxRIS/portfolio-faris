  ...
  return (
    <>
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Punya pertanyaan, kerja sama, atau proyek yang ingin dibahas? Kirim
          pesan, saya akan segera membalasnya.
        </p>
      </div>
      ...
      >
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12">
          ...
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Punya proyek, pertanyaan, atau ingin kerja sama? Kirim pesan
                  dan mari berdiskusi!
                </p>
              </div>
            ...
            <form
              action="https://formsubmit.co/faizraziq1@gmail.com"
              method="POST"
