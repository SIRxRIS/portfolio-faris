...
const TECH_STACK = ["React", "Javascript", "Next.js", "Tailwind", "Supabase"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/SirxRis" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/" },
  { icon: Instagram, link: "https://www.instagram.com/s.iraf_/" },
];
